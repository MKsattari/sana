	...
	<li class="yt-register inline">
			...
			if ($usersConfig->get('allowUserRegistration')) : ?>
				...
				<a 
					...
					>
					<span class="title-link"><i class="fa fa-sign-in"></i><?php echo JText::_('SIGN_UP');?></span>
				</a>
			<?php endif; ?>	
			
			<div id="yt_register_box" class="show-box" style="display:none">
				<div class="inner">
					<h3><i class="fa fa-sign-in"></i><?php echo JText::_('JREGISTER');?></h3>	
				</div>
			</div>
		...
		<a class="login-switch" data-toggle="modal" href="#myLogin" title="<?php  echo JText::_('MOD_LOGIN_ME');?>">
			<i class="fa fa-user"></i><?php echo JText::_('MOD_LOGIN_ME');?>
		</a>
        </li>
