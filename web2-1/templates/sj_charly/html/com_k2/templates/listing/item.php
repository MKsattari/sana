...
<div id="k2Container" class="itemView<?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <?php if($this->item->params->get('itemTags') && count($this->item->tags)): ?>
	...
	<div class="itemTagsBlock">
		<h3 class="title-tags"><span><?php echo JText::_('K2_TAGGED'); ?></span></h3>
		<ul class="itemTags">
  ...
  <!-- Author Block -->
  <h3 class="title-author"><span><?php echo JText::_('K2_AUTHOR_BLOCK'); ?></span></h3>
  ...
  <!-- Related items by tag -->
	<div class="itemRelated">
		<h3 class="title-related"><span><?php echo JText::_("K2_RELATED_ITEMS_BY_TAG"); ?></span></h3>
		<ul class="items">
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <div class="itemComments">
	  ...
	  <h3 class="itemCommentsCounter">
	  	<span><?php echo JText::_('K2_COMMENT_ITEM'); ?></span>
	  </h3>
	  <div class="line"></div>
