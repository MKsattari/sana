...
$sana_project_add = NULL; // Initialize page object first

class csana_project_add extends csana_project {
	...
	// Page object name
	var $PageObjName = 'sana_project_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "sana_projectview.php")
...
// Create page object
if (!isset($sana_project_add)) $sana_project_add = new csana_project_add();

// Page init
$sana_project_add->Page_Init();

// Page main
$sana_project_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$sana_project_add->Page_Render();
?>
...
var CurrentForm = fsana_projectadd = new ew_Form("fsana_projectadd", "add");

// Validate form
fsana_projectadd.Validate = function() {
...
fsana_projectadd.Form_CustomValidate = 
...
fsana_projectadd.ValidateRequired = true;
<?php } else { ?>
fsana_projectadd.ValidateRequired = false; 
<?php } ?>
...
<?php $sana_project_add->ShowPageHeader(); ?>
<?php
$sana_project_add->ShowMessage();
?>
<form name="fsana_projectadd" id="fsana_projectadd" class="<?php echo $sana_project_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($sana_project_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $sana_project_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $sana_project_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fsana_projectadd.Init();
</script>
<?php
$sana_project_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$sana_project_add->Page_Terminate();
?>
