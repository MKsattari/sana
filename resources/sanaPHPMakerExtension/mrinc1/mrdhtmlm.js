	...
	var degreesToDarkenOrLighten = 15; // How many percent point to darken the color above on mouse over (10-15 percent point is usually enough).
	...
	************************************************************************************************************/
	...
	function mrdhtmlm_initMenu()
	{
		menuObj = document.getElementById('dhtml_menu');
	...
	window.onload = mrdhtmlm_initMenu;
