...
$sana_location_level6_edit = NULL; // Initialize page object first

class csana_location_level6_edit extends csana_location_level6 {
	...
	// Page object name
	var $PageObjName = 'sana_location_level6_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->locationLevel6ID->CurrentValue == "")
			$this->Page_Terminate("sana_location_level6list.php"); // Invalid key, return to list
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->locationLevel6ID->FldIsDetailKey)
			$this->locationLevel6ID->setFormValue($objForm->GetValue("x_locationLevel6ID"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->locationLevel6ID->CurrentValue = $this->locationLevel6ID->FormValue;
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// locationLevel5ID
			$this->locationLevel5ID->SetDbValueDef($rsnew, $this->locationLevel5ID->CurrentValue, 0, $this->locationLevel5ID->ReadOnly);

			// locationLevel5Name
			$this->locationLevel5Name->SetDbValueDef($rsnew, $this->locationLevel5Name->CurrentValue, "", $this->locationLevel5Name->ReadOnly);
...
// Create page object
if (!isset($sana_location_level6_edit)) $sana_location_level6_edit = new csana_location_level6_edit();

// Page init
$sana_location_level6_edit->Page_Init();

// Page main
$sana_location_level6_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$sana_location_level6_edit->Page_Render();
?>
...
var CurrentForm = fsana_location_level6edit = new ew_Form("fsana_location_level6edit", "edit");

// Validate form
fsana_location_level6edit.Validate = function() {
...
fsana_location_level6edit.Form_CustomValidate = 
...
fsana_location_level6edit.ValidateRequired = true;
<?php } else { ?>
fsana_location_level6edit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fsana_location_level6edit.Lists["x_locationLevel5ID"] = {"LinkField":"x_locationLevel5ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_locationName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $sana_location_level6_edit->ShowPageHeader(); ?>
<?php
$sana_location_level6_edit->ShowMessage();
?>
<form name="fsana_location_level6edit" id="fsana_location_level6edit" class="<?php echo $sana_location_level6_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($sana_location_level6_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $sana_location_level6_edit->Token ?>">
<?php } ?>
...
<?php if ($sana_location_level6->locationLevel6ID->Visible) { // locationLevel6ID ?>
	<div id="r_locationLevel6ID" class="form-group">
		<label id="elh_sana_location_level6_locationLevel6ID" class="col-sm-2 control-label ewLabel"><?php echo $sana_location_level6->locationLevel6ID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $sana_location_level6->locationLevel6ID->CellAttributes() ?>>
<span id="el_sana_location_level6_locationLevel6ID">
<span<?php echo $sana_location_level6->locationLevel6ID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $sana_location_level6->locationLevel6ID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="sana_location_level6" data-field="x_locationLevel6ID" name="x_locationLevel6ID" id="x_locationLevel6ID" value="<?php echo ew_HtmlEncode($sana_location_level6->locationLevel6ID->CurrentValue) ?>">
<?php echo $sana_location_level6->locationLevel6ID->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $sana_location_level6_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fsana_location_level6edit.Init();
</script>
<?php
$sana_location_level6_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$sana_location_level6_edit->Page_Terminate();
?>
