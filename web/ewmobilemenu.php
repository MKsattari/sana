...
$RootMenu->AddMenuItem(2, "mmi_sana_object", $Language->MenuPhrase("2", "MenuText"), "sana_objectlist.php", -1, "", AllowListMenu('{07091A10-D58A-4784-942B-0E21010F5DFC}sana_object'), FALSE);
...
$RootMenu->AddMenuItem(12, "mmi_sana_location_level4", $Language->MenuPhrase("12", "MenuText"), "sana_location_level4list.php", -1, "", AllowListMenu('{07091A10-D58A-4784-942B-0E21010F5DFC}sana_location_level4'), FALSE);
$RootMenu->AddMenuItem(13, "mmi_sana_location_level5", $Language->MenuPhrase("13", "MenuText"), "sana_location_level5list.php", -1, "", AllowListMenu('{07091A10-D58A-4784-942B-0E21010F5DFC}sana_location_level5'), FALSE);
$RootMenu->AddMenuItem(14, "mmi_sana_location_level6", $Language->MenuPhrase("14", "MenuText"), "sana_location_level6list.php", -1, "", AllowListMenu('{07091A10-D58A-4784-942B-0E21010F5DFC}sana_location_level6'), FALSE);
