...
<?php
	...
	if ($sana_message->CurrentAction == "" && $sana_message_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$sana_message_list->setWarningMessage($Language->Phrase("NoPermission"));
...
<option value="20"<?php if ($sana_message_list->DisplayRecs == 20) { ?> selected="selected"<?php } ?>>20</option>
<option value="50"<?php if ($sana_message_list->DisplayRecs == 50) { ?> selected="selected"<?php } ?>>50</option>
<option value="100"<?php if ($sana_message_list->DisplayRecs == 100) { ?> selected="selected"<?php } ?>>100</option>
<option value="500"<?php if ($sana_message_list->DisplayRecs == 500) { ?> selected="selected"<?php } ?>>500</option>
</select>
</div>
<?php } ?>
</form>
