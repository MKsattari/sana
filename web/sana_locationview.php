...
$sana_location_view = NULL; // Initialize page object first

class csana_location_view extends csana_location {
	...
	// Page object name
	var $PageObjName = 'sana_location_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["locationID"] <> "") {
			$this->RecKey["locationID"] = $_GET["locationID"];
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["locationID"] <> "") {
				...
				$this->locationID->setFormValue($_POST["locationID"]);
				$this->RecKey["locationID"] = $this->locationID->FormValue;
			} else {
				$sReturnUrl = "sana_locationlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "sana_locationlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "sana_locationlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($sana_location_view)) $sana_location_view = new csana_location_view();

// Page init
$sana_location_view->Page_Init();

// Page main
$sana_location_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$sana_location_view->Page_Render();
?>
...
var CurrentForm = fsana_locationview = new ew_Form("fsana_locationview", "view");

// Form_CustomValidate event
fsana_locationview.Form_CustomValidate = 
...
fsana_locationview.ValidateRequired = true;
<?php } else { ?>
fsana_locationview.ValidateRequired = false; 
<?php } ?>
...
<?php $sana_location_view->ExportOptions->Render("body") ?>
<?php
	foreach ($sana_location_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $sana_location_view->ShowPageHeader(); ?>
<?php
$sana_location_view->ShowMessage();
?>
<form name="fsana_locationview" id="fsana_locationview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($sana_location_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $sana_location_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="sana_location">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($sana_location->locationID->Visible) { // locationID ?>
	<tr id="r_locationID">
		<td><span id="elh_sana_location_locationID"><?php echo $sana_location->locationID->FldCaption() ?></span></td>
...
<?php echo $sana_location->locationID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location->locationClass->Visible) { // locationClass ?>
	<tr id="r_locationClass">
		<td><span id="elh_sana_location_locationClass"><?php echo $sana_location->locationClass->FldCaption() ?></span></td>
...
<?php echo $sana_location->locationClass->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location->locationName->Visible) { // locationName ?>
	<tr id="r_locationName">
		<td><span id="elh_sana_location_locationName"><?php echo $sana_location->locationName->FldCaption() ?></span></td>
...
<?php echo $sana_location->locationName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location->parentID->Visible) { // parentID ?>
	<tr id="r_parentID">
		<td><span id="elh_sana_location_parentID"><?php echo $sana_location->parentID->FldCaption() ?></span></td>
...
<?php echo $sana_location->parentID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location->hierarchyIDPath->Visible) { // hierarchyIDPath ?>
	<tr id="r_hierarchyIDPath">
		<td><span id="elh_sana_location_hierarchyIDPath"><?php echo $sana_location->hierarchyIDPath->FldCaption() ?></span></td>
...
<?php echo $sana_location->hierarchyIDPath->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location->hierarchyPath->Visible) { // hierarchyPath ?>
	<tr id="r_hierarchyPath">
		<td><span id="elh_sana_location_hierarchyPath"><?php echo $sana_location->hierarchyPath->FldCaption() ?></span></td>
...
<?php echo $sana_location->hierarchyPath->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fsana_locationview.Init();
</script>
<?php
$sana_location_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$sana_location_view->Page_Terminate();
?>
