...
<div id="k2Container" class="itemListView listing-event<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemList">
		...
		<div id="itemListLeading" class="row">
			...
			<?php
			// Define a CSS class for the last container on each row
			if( ($key+1)==($this->params->get('num_leading_items')) )
			...
			<?php if( ($key+1)==($this->params->get('num_leading_items')) ): ?>
			<div class="clr"></div>
			<?php endif; ?>
			<?php endforeach; ?>
			<div class="clr"></div>
		...
		<div id="itemListPrimary" class="row">
			...
			<?php
			// Define a CSS class for the last container on each row
			if( ($key+1)==($this->params->get('num_primary_items')) )
				$lastContainer= ' itemContainerLast';
			else
				$lastContainer='';
			...
			<?php if( ($key+1)==($this->params->get('num_primary_items')) ): ?>
			<div class="clr"></div>
			<?php endif; ?>
			<?php endforeach; ?>
			<div class="clr"></div>
