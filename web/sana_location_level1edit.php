...
$sana_location_level1_edit = NULL; // Initialize page object first

class csana_location_level1_edit extends csana_location_level1 {
	...
	// Page object name
	var $PageObjName = 'sana_location_level1_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->locationLevel1ID->CurrentValue == "")
			$this->Page_Terminate("sana_location_level1list.php"); // Invalid key, return to list
...
// Create page object
if (!isset($sana_location_level1_edit)) $sana_location_level1_edit = new csana_location_level1_edit();

// Page init
$sana_location_level1_edit->Page_Init();

// Page main
$sana_location_level1_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$sana_location_level1_edit->Page_Render();
?>
...
var CurrentForm = fsana_location_level1edit = new ew_Form("fsana_location_level1edit", "edit");

// Validate form
fsana_location_level1edit.Validate = function() {
...
fsana_location_level1edit.Form_CustomValidate = 
...
fsana_location_level1edit.ValidateRequired = true;
<?php } else { ?>
fsana_location_level1edit.ValidateRequired = false; 
<?php } ?>
...
<?php $sana_location_level1_edit->ShowPageHeader(); ?>
<?php
$sana_location_level1_edit->ShowMessage();
?>
<form name="fsana_location_level1edit" id="fsana_location_level1edit" class="<?php echo $sana_location_level1_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($sana_location_level1_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $sana_location_level1_edit->Token ?>">
<?php } ?>
...
<?php if ($sana_location_level1->locationLevel1ID->Visible) { // locationLevel1ID ?>
	<div id="r_locationLevel1ID" class="form-group">
		<label id="elh_sana_location_level1_locationLevel1ID" class="col-sm-2 control-label ewLabel"><?php echo $sana_location_level1->locationLevel1ID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $sana_location_level1->locationLevel1ID->CellAttributes() ?>>
<span id="el_sana_location_level1_locationLevel1ID">
<span<?php echo $sana_location_level1->locationLevel1ID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $sana_location_level1->locationLevel1ID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="sana_location_level1" data-field="x_locationLevel1ID" name="x_locationLevel1ID" id="x_locationLevel1ID" value="<?php echo ew_HtmlEncode($sana_location_level1->locationLevel1ID->CurrentValue) ?>">
<?php echo $sana_location_level1->locationLevel1ID->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $sana_location_level1_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fsana_location_level1edit.Init();
</script>
<?php
$sana_location_level1_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$sana_location_level1_edit->Page_Terminate();
?>
