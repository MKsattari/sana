	...
	<a class="k2Avatar moduleItemAuthorAvatar" rel="author" href="<?php echo $item->authorLink; ?>">
      ...
      <div class="moduleItemIntrotext">
	      ...
	      <a class="moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
		       ...
		       <span class="date"><?php echo  JHTML::_('date', $item->created,JText::_('j')) ;?></span>
		       <?php endif; ?>
	      </a>
	      <?php endif; ?>
	      <div class="main">
		...
		<?php endif; ?>
		<?php if(($params->get('itemCommentsCounter') && ($componentParams->get('comments'))) || ($params->get('itemAuthor'))): ?>	
		<aside class="article-aside">
			<dl class="article-info  muted">
				...
				<dd class="catItemAuthor">
					...
					<a rel="author" title="<?php echo K2HelperUtilities::cleanHtml($item->author); ?>" href="<?php echo $item->authorLink; ?>"><i class="fa fa-pencil-square-o"></i><?php echo JText::_('BY'),'&nbsp;',$item->author;?></a>
					<?php else: ?>
					<i class="fa fa-pencil-square-o"></i><?php echo $item->author; ?>
					<?php endif; ?>
				</dd>
				<?php endif; ?>
				...
				<dd>
					...
					<?php else: ?>
						...
						<?php else: ?>
						<a class="moduleItemComments" href="<?php echo $item->link.'#itemCommentsAnchor'; ?>">
							<i class="fa fa-comments-o"></i><?php echo JText::_('K2_THE_FIRST_TO_COMMENT'); ?>
						</a>
						<?php endif; ?>
					<?php endif; ?>
				</dd>
