...
$sana_location_level4_edit = NULL; // Initialize page object first

class csana_location_level4_edit extends csana_location_level4 {
	...
	// Page object name
	var $PageObjName = 'sana_location_level4_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->locationLevel4ID->CurrentValue == "")
			$this->Page_Terminate("sana_location_level4list.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// locationLevel3Name
			$this->locationLevel3Name->SetDbValueDef($rsnew, $this->locationLevel3Name->CurrentValue, "", $this->locationLevel3Name->ReadOnly);
...
// Create page object
if (!isset($sana_location_level4_edit)) $sana_location_level4_edit = new csana_location_level4_edit();

// Page init
$sana_location_level4_edit->Page_Init();

// Page main
$sana_location_level4_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$sana_location_level4_edit->Page_Render();
?>
...
var CurrentForm = fsana_location_level4edit = new ew_Form("fsana_location_level4edit", "edit");

// Validate form
fsana_location_level4edit.Validate = function() {
...
fsana_location_level4edit.Form_CustomValidate = 
...
fsana_location_level4edit.ValidateRequired = true;
<?php } else { ?>
fsana_location_level4edit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fsana_location_level4edit.Lists["x_locationLevel3ID"] = {"LinkField":"x_locationLevel3ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_locationName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $sana_location_level4_edit->ShowPageHeader(); ?>
<?php
$sana_location_level4_edit->ShowMessage();
?>
<form name="fsana_location_level4edit" id="fsana_location_level4edit" class="<?php echo $sana_location_level4_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($sana_location_level4_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $sana_location_level4_edit->Token ?>">
<?php } ?>
...
<?php if ($sana_location_level4->locationLevel4ID->Visible) { // locationLevel4ID ?>
	<div id="r_locationLevel4ID" class="form-group">
		<label id="elh_sana_location_level4_locationLevel4ID" class="col-sm-2 control-label ewLabel"><?php echo $sana_location_level4->locationLevel4ID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $sana_location_level4->locationLevel4ID->CellAttributes() ?>>
<span id="el_sana_location_level4_locationLevel4ID">
<span<?php echo $sana_location_level4->locationLevel4ID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $sana_location_level4->locationLevel4ID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="sana_location_level4" data-field="x_locationLevel4ID" name="x_locationLevel4ID" id="x_locationLevel4ID" value="<?php echo ew_HtmlEncode($sana_location_level4->locationLevel4ID->CurrentValue) ?>">
<?php echo $sana_location_level4->locationLevel4ID->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $sana_location_level4_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fsana_location_level4edit.Init();
</script>
<?php
$sana_location_level4_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$sana_location_level4_edit->Page_Terminate();
?>
