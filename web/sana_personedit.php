...
class csana_person_edit extends csana_person {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// fatherName
			$this->fatherName->SetDbValueDef($rsnew, $this->fatherName->CurrentValue, NULL, $this->fatherName->ReadOnly);

			// gender
			$this->gender->SetDbValueDef($rsnew, $this->gender->CurrentValue, "", $this->gender->ReadOnly);

			// locationLevel1
			$this->locationLevel1->SetDbValueDef($rsnew, $this->locationLevel1->CurrentValue, "", $this->locationLevel1->ReadOnly);

			// locationLevel2
			$this->locationLevel2->SetDbValueDef($rsnew, $this->locationLevel2->CurrentValue, "", $this->locationLevel2->ReadOnly);

			// locationLevel3
			$this->locationLevel3->SetDbValueDef($rsnew, $this->locationLevel3->CurrentValue, NULL, $this->locationLevel3->ReadOnly);

			// locationLevel4
			$this->locationLevel4->SetDbValueDef($rsnew, $this->locationLevel4->CurrentValue, NULL, $this->locationLevel4->ReadOnly);

			// locationLevel5
			$this->locationLevel5->SetDbValueDef($rsnew, $this->locationLevel5->CurrentValue, NULL, $this->locationLevel5->ReadOnly);

			// locationLevel6
			$this->locationLevel6->SetDbValueDef($rsnew, $this->locationLevel6->CurrentValue, NULL, $this->locationLevel6->ReadOnly);
...
// Multi-Page
fsana_personedit.MultiPage = new ew_MultiPage("fsana_personedit");

// Dynamic selection lists
fsana_personedit.Lists["x_gender"] = {"LinkField":"x_stateName","Ajax":true,"AutoFill":false,"DisplayFields":["x_stateName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fsana_personedit.Lists["x_locationLevel1"] = {"LinkField":"x_locationName","Ajax":true,"AutoFill":false,"DisplayFields":["x_locationName","","",""],"ParentFields":[],"ChildFields":["x_locationLevel2"],"FilterFields":[],"Options":[],"Template":""};
fsana_personedit.Lists["x_locationLevel2"] = {"LinkField":"x_locationName","Ajax":true,"AutoFill":false,"DisplayFields":["x_locationName","","",""],"ParentFields":["x_locationLevel1"],"ChildFields":["x_locationLevel3"],"FilterFields":["x_locationLevel1Name"],"Options":[],"Template":""};
fsana_personedit.Lists["x_locationLevel3"] = {"LinkField":"x_locationName","Ajax":true,"AutoFill":false,"DisplayFields":["x_locationName","","",""],"ParentFields":["x_locationLevel2"],"ChildFields":[],"FilterFields":["x_locationLevel2Name"],"Options":[],"Template":""};
fsana_personedit.Lists["x_status"] = {"LinkField":"x_stateName","Ajax":true,"AutoFill":false,"DisplayFields":["x_stateName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fsana_personedit.Lists["x_ageRange"] = {"LinkField":"x_stateName","Ajax":true,"AutoFill":false,"DisplayFields":["x_stateName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fsana_personedit.Lists["x_registrationStation"] = {"LinkField":"x_stationID","Ajax":true,"AutoFill":false,"DisplayFields":["x_stationID","x_stationName","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<div class="panel-group" id="sana_person_edit">
	<div class="panel panel-default<?php echo $sana_person_edit->MultiPages->PageStyle("1") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#sana_person_edit" href="#tab_sana_person1"><?php echo $sana_person->PageCaption(1) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $sana_person_edit->MultiPages->PageStyle("1") ?>" id="tab_sana_person1">
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $sana_person_edit->MultiPages->PageStyle("2") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#sana_person_edit" href="#tab_sana_person2"><?php echo $sana_person->PageCaption(2) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $sana_person_edit->MultiPages->PageStyle("2") ?>" id="tab_sana_person2">
			<div class="panel-body">
<div>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $sana_person_edit->MultiPages->PageStyle("3") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#sana_person_edit" href="#tab_sana_person3"><?php echo $sana_person->PageCaption(3) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $sana_person_edit->MultiPages->PageStyle("3") ?>" id="tab_sana_person3">
			<div class="panel-body">
<div>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $sana_person_edit->MultiPages->PageStyle("4") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#sana_person_edit" href="#tab_sana_person4"><?php echo $sana_person->PageCaption(4) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $sana_person_edit->MultiPages->PageStyle("4") ?>" id="tab_sana_person4">
			<div class="panel-body">
<div>
