...
$sana_location_level2_view = NULL; // Initialize page object first

class csana_location_level2_view extends csana_location_level2 {
	...
	// Page object name
	var $PageObjName = 'sana_location_level2_view';
	...
	function __construct() {
		...
		if (@$_GET["locationLevel2ID"] <> "") {
			$this->RecKey["locationLevel2ID"] = $_GET["locationLevel2ID"];
			$KeyUrl .= "&amp;locationLevel2ID=" . urlencode($this->RecKey["locationLevel2ID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["locationLevel2ID"] <> "") {
				...
				$this->RecKey["locationLevel2ID"] = $this->locationLevel2ID->QueryStringValue;
			} elseif (@$_POST["locationLevel2ID"] <> "") {
				$this->locationLevel2ID->setFormValue($_POST["locationLevel2ID"]);
				$this->RecKey["locationLevel2ID"] = $this->locationLevel2ID->FormValue;
			} else {
				$sReturnUrl = "sana_location_level2list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "sana_location_level2list.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "sana_location_level2list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($sana_location_level2_view)) $sana_location_level2_view = new csana_location_level2_view();

// Page init
$sana_location_level2_view->Page_Init();

// Page main
$sana_location_level2_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$sana_location_level2_view->Page_Render();
?>
...
var CurrentForm = fsana_location_level2view = new ew_Form("fsana_location_level2view", "view");

// Form_CustomValidate event
fsana_location_level2view.Form_CustomValidate = 
...
fsana_location_level2view.ValidateRequired = true;
<?php } else { ?>
fsana_location_level2view.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fsana_location_level2view.Lists["x_locationLevel1ID"] = {"LinkField":"x_locationLevel1ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_locationName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $sana_location_level2_view->ExportOptions->Render("body") ?>
<?php
	foreach ($sana_location_level2_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $sana_location_level2_view->ShowPageHeader(); ?>
<?php
$sana_location_level2_view->ShowMessage();
?>
<form name="fsana_location_level2view" id="fsana_location_level2view" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($sana_location_level2_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $sana_location_level2_view->Token ?>">
<?php } ?>
...
<?php if ($sana_location_level2->locationLevel2ID->Visible) { // locationLevel2ID ?>
	<tr id="r_locationLevel2ID">
		<td><span id="elh_sana_location_level2_locationLevel2ID"><?php echo $sana_location_level2->locationLevel2ID->FldCaption() ?></span></td>
...
<?php echo $sana_location_level2->locationLevel2ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location_level2->locationName->Visible) { // locationName ?>
	<tr id="r_locationName">
		<td><span id="elh_sana_location_level2_locationName"><?php echo $sana_location_level2->locationName->FldCaption() ?></span></td>
...
<?php echo $sana_location_level2->locationName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location_level2->locationLevel1ID->Visible) { // locationLevel1ID ?>
	<tr id="r_locationLevel1ID">
		<td><span id="elh_sana_location_level2_locationLevel1ID"><?php echo $sana_location_level2->locationLevel1ID->FldCaption() ?></span></td>
...
<?php echo $sana_location_level2->locationLevel1ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location_level2->locationLevel1Name->Visible) { // locationLevel1Name ?>
	<tr id="r_locationLevel1Name">
		<td><span id="elh_sana_location_level2_locationLevel1Name"><?php echo $sana_location_level2->locationLevel1Name->FldCaption() ?></span></td>
...
<?php echo $sana_location_level2->locationLevel1Name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fsana_location_level2view.Init();
</script>
<?php
$sana_location_level2_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$sana_location_level2_view->Page_Terminate();
?>
