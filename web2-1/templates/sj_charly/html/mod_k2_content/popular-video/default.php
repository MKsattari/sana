  ...
  <ul>
	...
	<a class="k2Avatar moduleItemAuthorAvatar" rel="author" href="<?php echo $item->authorLink; ?>">
      ...
      <div class="moduleItemIntrotext">
		<?php if($params->get('itemVideo') && ($item->video != null)): ?>
		      ...
		      <a class="moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
				<?php 	
				   ...
				   if (!empty( $src)) {								
					   ...
					   $thumb_img = yt_placehold($placehold_size['popular_video'],$item->title,$item->title); 
					  //var_dump( $thumb_img);
				   }	
				   echo $thumb_img;
			       ?>
			       <i class="icon-video fa fa-play"></i>
		      </a>
		      <?php endif; ?>
		<?php else: ?>
		<?php if($params->get('itemImage')): ?>
		      <a class="moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
				<?php 	
				   ...
				   echo $thumb_img;
			       ?>
			       <span class="no-video"><?php echo JText::_('NO_VIDEO'); ?></span>
		      </a>
		      <?php endif; ?>
		<?php endif; ?>
		<div class="main">
