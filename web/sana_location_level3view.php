...
$sana_location_level3_view = NULL; // Initialize page object first

class csana_location_level3_view extends csana_location_level3 {
	...
	// Page object name
	var $PageObjName = 'sana_location_level3_view';
	...
	function __construct() {
		...
		if (@$_GET["locationLevel3ID"] <> "") {
			$this->RecKey["locationLevel3ID"] = $_GET["locationLevel3ID"];
			$KeyUrl .= "&amp;locationLevel3ID=" . urlencode($this->RecKey["locationLevel3ID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["locationLevel3ID"] <> "") {
				...
				$this->RecKey["locationLevel3ID"] = $this->locationLevel3ID->QueryStringValue;
			} elseif (@$_POST["locationLevel3ID"] <> "") {
				$this->locationLevel3ID->setFormValue($_POST["locationLevel3ID"]);
				$this->RecKey["locationLevel3ID"] = $this->locationLevel3ID->FormValue;
			} else {
				$sReturnUrl = "sana_location_level3list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "sana_location_level3list.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "sana_location_level3list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($sana_location_level3_view)) $sana_location_level3_view = new csana_location_level3_view();

// Page init
$sana_location_level3_view->Page_Init();

// Page main
$sana_location_level3_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$sana_location_level3_view->Page_Render();
?>
...
var CurrentForm = fsana_location_level3view = new ew_Form("fsana_location_level3view", "view");

// Form_CustomValidate event
fsana_location_level3view.Form_CustomValidate = 
...
fsana_location_level3view.ValidateRequired = true;
<?php } else { ?>
fsana_location_level3view.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fsana_location_level3view.Lists["x_locationLevel1ID"] = {"LinkField":"x_locationLevel1ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_locationName","","",""],"ParentFields":[],"ChildFields":["x_locationLevel2ID"],"FilterFields":[],"Options":[],"Template":""};
fsana_location_level3view.Lists["x_locationLevel2ID"] = {"LinkField":"x_locationLevel2ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_locationName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $sana_location_level3_view->ExportOptions->Render("body") ?>
<?php
	foreach ($sana_location_level3_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $sana_location_level3_view->ShowPageHeader(); ?>
<?php
$sana_location_level3_view->ShowMessage();
?>
<form name="fsana_location_level3view" id="fsana_location_level3view" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($sana_location_level3_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $sana_location_level3_view->Token ?>">
<?php } ?>
...
<?php if ($sana_location_level3->locationLevel3ID->Visible) { // locationLevel3ID ?>
	<tr id="r_locationLevel3ID">
		<td><span id="elh_sana_location_level3_locationLevel3ID"><?php echo $sana_location_level3->locationLevel3ID->FldCaption() ?></span></td>
...
<?php echo $sana_location_level3->locationLevel3ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location_level3->locationName->Visible) { // locationName ?>
	<tr id="r_locationName">
		<td><span id="elh_sana_location_level3_locationName"><?php echo $sana_location_level3->locationName->FldCaption() ?></span></td>
...
<?php echo $sana_location_level3->locationName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location_level3->locationLevel1ID->Visible) { // locationLevel1ID ?>
	<tr id="r_locationLevel1ID">
		<td><span id="elh_sana_location_level3_locationLevel1ID"><?php echo $sana_location_level3->locationLevel1ID->FldCaption() ?></span></td>
...
<?php echo $sana_location_level3->locationLevel1ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location_level3->locationLevel2ID->Visible) { // locationLevel2ID ?>
	<tr id="r_locationLevel2ID">
		<td><span id="elh_sana_location_level3_locationLevel2ID"><?php echo $sana_location_level3->locationLevel2ID->FldCaption() ?></span></td>
...
<?php echo $sana_location_level3->locationLevel2ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location_level3->locationLevel2Name->Visible) { // locationLevel2Name ?>
	<tr id="r_locationLevel2Name">
		<td><span id="elh_sana_location_level3_locationLevel2Name"><?php echo $sana_location_level3->locationLevel2Name->FldCaption() ?></span></td>
...
<?php echo $sana_location_level3->locationLevel2Name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fsana_location_level3view.Init();
</script>
<?php
$sana_location_level3_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$sana_location_level3_view->Page_Terminate();
?>
