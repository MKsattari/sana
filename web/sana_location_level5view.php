...
$sana_location_level5_view = NULL; // Initialize page object first

class csana_location_level5_view extends csana_location_level5 {
	...
	// Page object name
	var $PageObjName = 'sana_location_level5_view';
	...
	function __construct() {
		...
		if (@$_GET["locationLevel5ID"] <> "") {
			$this->RecKey["locationLevel5ID"] = $_GET["locationLevel5ID"];
			$KeyUrl .= "&amp;locationLevel5ID=" . urlencode($this->RecKey["locationLevel5ID"]);
		}
	...
	function Page_Init() {
		...
		if (!$Security->CanView()) {
			...
			if ($Security->CanList())
				$this->Page_Terminate(ew_GetUrl("sana_location_level5list.php"));
			else
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["locationLevel5ID"] <> "") {
				...
				$this->RecKey["locationLevel5ID"] = $this->locationLevel5ID->QueryStringValue;
			} elseif (@$_POST["locationLevel5ID"] <> "") {
				$this->locationLevel5ID->setFormValue($_POST["locationLevel5ID"]);
				$this->RecKey["locationLevel5ID"] = $this->locationLevel5ID->FormValue;
			} else {
				$sReturnUrl = "sana_location_level5list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "sana_location_level5list.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "sana_location_level5list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($sana_location_level5_view)) $sana_location_level5_view = new csana_location_level5_view();

// Page init
$sana_location_level5_view->Page_Init();

// Page main
$sana_location_level5_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$sana_location_level5_view->Page_Render();
?>
...
var CurrentForm = fsana_location_level5view = new ew_Form("fsana_location_level5view", "view");

// Form_CustomValidate event
fsana_location_level5view.Form_CustomValidate = 
...
fsana_location_level5view.ValidateRequired = true;
<?php } else { ?>
fsana_location_level5view.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fsana_location_level5view.Lists["x_locationLevel4ID"] = {"LinkField":"x_locationLevel4ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_locationName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $sana_location_level5_view->ExportOptions->Render("body") ?>
<?php
	foreach ($sana_location_level5_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $sana_location_level5_view->ShowPageHeader(); ?>
<?php
$sana_location_level5_view->ShowMessage();
?>
<form name="fsana_location_level5view" id="fsana_location_level5view" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($sana_location_level5_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $sana_location_level5_view->Token ?>">
<?php } ?>
...
<?php if ($sana_location_level5->locationLevel5ID->Visible) { // locationLevel5ID ?>
	<tr id="r_locationLevel5ID">
		<td><span id="elh_sana_location_level5_locationLevel5ID"><?php echo $sana_location_level5->locationLevel5ID->FldCaption() ?></span></td>
...
<?php echo $sana_location_level5->locationLevel5ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location_level5->locationName->Visible) { // locationName ?>
	<tr id="r_locationName">
		<td><span id="elh_sana_location_level5_locationName"><?php echo $sana_location_level5->locationName->FldCaption() ?></span></td>
...
<?php echo $sana_location_level5->locationName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location_level5->locationLevel4ID->Visible) { // locationLevel4ID ?>
	<tr id="r_locationLevel4ID">
		<td><span id="elh_sana_location_level5_locationLevel4ID"><?php echo $sana_location_level5->locationLevel4ID->FldCaption() ?></span></td>
...
<?php echo $sana_location_level5->locationLevel4ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location_level5->locationLevel4Name->Visible) { // locationLevel4Name ?>
	<tr id="r_locationLevel4Name">
		<td><span id="elh_sana_location_level5_locationLevel4Name"><?php echo $sana_location_level5->locationLevel4Name->FldCaption() ?></span></td>
...
<?php echo $sana_location_level5->locationLevel4Name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location_level5->locationLevel1ID->Visible) { // locationLevel1ID ?>
	<tr id="r_locationLevel1ID">
		<td><span id="elh_sana_location_level5_locationLevel1ID"><?php echo $sana_location_level5->locationLevel1ID->FldCaption() ?></span></td>
...
<?php echo $sana_location_level5->locationLevel1ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location_level5->locationLevel2ID->Visible) { // locationLevel2ID ?>
	<tr id="r_locationLevel2ID">
		<td><span id="elh_sana_location_level5_locationLevel2ID"><?php echo $sana_location_level5->locationLevel2ID->FldCaption() ?></span></td>
...
<?php echo $sana_location_level5->locationLevel2ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sana_location_level5->locationLevel3ID->Visible) { // locationLevel3ID ?>
	<tr id="r_locationLevel3ID">
		<td><span id="elh_sana_location_level5_locationLevel3ID"><?php echo $sana_location_level5->locationLevel3ID->FldCaption() ?></span></td>
...
<?php echo $sana_location_level5->locationLevel3ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fsana_location_level5view.Init();
</script>
<?php
$sana_location_level5_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$sana_location_level5_view->Page_Terminate();
?>
