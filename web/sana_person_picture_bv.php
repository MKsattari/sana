...
$sana_person_picture_blobview = NULL; // Initialize page object first

class csana_person_picture_blobview extends csana_person {
	...
	// Page object name
	var $PageObjName = 'sana_person_picture_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('sana_person', 'x_picture');

		// Show thumbnail
		$bShowThumbnail = (@$_GET["showthumbnail"] == "1");
		if (@$_GET["thumbnailwidth"] == "" && @$_GET["thumbnailheight"] == "") {
			$iThumbnailWidth = 70; // Set default width
			$iThumbnailHeight = 70; // Set default height
		} else {
...
// Create page object
if (!isset($sana_person_picture_blobview)) $sana_person_picture_blobview = new csana_person_picture_blobview();

// Page init
$sana_person_picture_blobview->Page_Init();

// Page main
$sana_person_picture_blobview->Page_Main();
?>
<?php
$sana_person_picture_blobview->Page_Terminate();
?>
