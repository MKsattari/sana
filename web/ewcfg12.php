...
define("EW_PROJECT_NAME", "sanaPHPMaker", TRUE); // Project name
...
define("EW_RANDOM_KEY", 'c46tLsj25Ij4jtgm', TRUE); // Random key for encryption
...
define("EW_LANGUAGE_DEFAULT_ID", "fa", TRUE);
...
define("EW_USER_NAME_FILTER", "(`mobilePhone` = '%u')", TRUE);
...
define("EW_UPLOAD_DEST_PATH", "fileUploades/", TRUE); // Upload destination path (relative to app root)
